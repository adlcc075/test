...
extern unsigned int USDHC_mx6dq_iomux_cfg[];
extern unsigned int USDHC_mx6dl_iomux_cfg[];
extern unsigned int USDHC_mx6sl_iomux_cfg[];
extern unsigned int USDHC_mx6sx_iomux_cfg[];
extern unsigned int USDHC_mx6ul_iomux_cfg[];
extern unsigned int USDHC_mx6ull_iomux_cfg[];


extern unsigned int NAND_mx6dq_iomux_cfg[];
extern unsigned int NAND_mx6dl_iomux_cfg[];
extern unsigned int NAND_mx6sl_iomux_cfg[];
extern unsigned int NAND_mx6sx_iomux_cfg[];
extern unsigned int NAND_mx6ul_iomux_cfg[];
extern unsigned int NAND_mx6ull_iomux_cfg[];
